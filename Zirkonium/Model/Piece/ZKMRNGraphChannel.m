...
{
	[self willChangeValueForKey: @"graphChannelIndex"];
	[self setPrimitiveValue: graphChannelIndex forKey: @"graphChannelIndex"];
	[self didChangeValueForKey: @"graphChannelIndex"];
}
...
- (ZKMNRPannerSource *)pannerSource
{
	...
	if (!pannerSource) {
		...
		if(!pannerSource) { NSLog(@"Error allocating panner source ..."); }
		...
		[self willChangeValueForKey:@"pannerSource"];
		[self setPrimitiveValue: pannerSource forKey: @"pannerSource"];
		[self didChangeValueForKey:@"pannerSource"];
	}
