...
///
@class ZKMRNStudioSetupDocument, ZKMRNPreferencesController, ZKMRNInputPatch, ZKMRNOutputPatch, ZKMORLoggerClient; //ZKMRNDirectOutPatch
@class ZKMRNSpeakerSetup, ZKMRNPieceDocument;
@class ZKMRNPreferencesController, /*ZKMRNOSCController,*/ /*ZKMRNAudioUnitController,*/ ZKMRNTestSourceController;
@class ZKMRNOutputPatchChannel, ZKMRNDirectOutPatchChannel;
@class LightController;

@class ZKMRNVirtualDeviceController; 
...
@interface ZKMRNZirkoniumSystem : NSObject  {
	...
	ZKMRNPieceDocument*		_currentPieceDocument; 
	// UI Objects
	IBOutlet NSPanel*				aboutPanel;
	
	//ZKMRNVirtualDeviceController*		_virtualDeviceController;
	...
	ZKMRNTestSourceController*		_testSourceController;
	//ZKMRNOSCMasterSlave*			_masterSlaveController; 
	...
	NSThread*						_spatializationTimerThread; 
	...
	NSThread*						_displayTimerThread; 
	
	NSTimer*						_loggerTimer;
	
	BOOL _isDisplayThreadRunning; 
	
	// @David
	NSString * _recordingOutputFormat;
}

// @David
@property (assign) NSString * _recordingOutputFormat;
...
-(NSTimeInterval)spatializationTimerInterval;

//-(ZKMRNOSCMasterSlave*)masterSlaveController;
...
-(void)setCurrentPieceDocument:(ZKMRNPieceDocument*)currentPieceDocument;
...
//- (ZKMRNVirtualDeviceController *)virtualDeviceController; 
