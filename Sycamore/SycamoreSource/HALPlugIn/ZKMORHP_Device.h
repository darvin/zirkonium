...
public:
								ZKMORHP_Device(AudioDeviceID inAudioDeviceID, ZKMORHP_PlugIn* inPlugIn, UInt32 numInputChannels, UInt32 numOutputChannels, CFStringRef deviceName, CFStringRef manuName, CFStringRef deviceUID, CFStringRef modelUID);
...
public:
	...
	ZKMORHP_IOThreadSlave*		GetIOThread() const { return mIOThread; }
...
//	HP_IOThread*				mIOThread;
	ZKMORHP_IOThreadSlave*		mIOThread;
